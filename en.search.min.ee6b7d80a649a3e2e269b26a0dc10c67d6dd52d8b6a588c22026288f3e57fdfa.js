...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5158ab1cc963f1cd67ab8ed0d560cf333c4ae5eecd7b25e3a71776e5a04eceeb.js',function(){input.required=false;search();});}
